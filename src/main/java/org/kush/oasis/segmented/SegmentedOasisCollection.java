...
public interface SegmentedOasisCollection extends  OasisCollection {       
    ...
    /**
     * The default location where all the persisted segments with the 
     * associated java process are stored. 
     * 
     * The store is created every time a new process is created and deleted
    ...
    public static final String BASE_STORE_NAME = System.getProperty("java.io.tmpdir") + File.separator + BASE_DIRECTORY_NAME + File.separator + PROCESS_ID + File.separator;
     ...
     * The store location 
     * 
     * @return The path to the location where the segments of this 
     * map are stored
     */
     ...
     * 
     * If this map is cached, it just the value returned is expected
     * number of segments to be persisted when cache is disabled
     * 
